...
class course_visibilitychanged extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '" . $this->userid . "' changed the visibility of the course with the id '" . $this->objectid .".";
    }
